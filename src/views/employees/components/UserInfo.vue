...
import { getPersonalDetail, updatePersonal, saveEmployee } from '@/api/employess'
...
export default {
  ...
  async created () {
    const res1 = await getUserDetailById(this.id)
    console.log(res1)
    this.userInfo = res1
    const res2 = await getPersonalDetail(this.id)
    console.log(res2)
    this.formData = res2
  },
  methods: {
